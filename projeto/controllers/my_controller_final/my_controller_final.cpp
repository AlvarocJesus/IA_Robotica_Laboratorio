...
int main(int argc, char **argv)
{
	...
	LED *led2 = robot->getLED("led1");
	LED *led3 = robot->getLED("led2");
	LED *led4 = robot->getLED("led3");
	LED *led5 = robot->getLED("led4");
	LED *led6 = robot->getLED("led5");
	LED *led7 = robot->getLED("led6");
	LED *led8 = robot->getLED("led7"); */
	LED *leds[8] = {led, led2, led3, led4, led5, led6, led7, led8};
	...
	while (robot->step(timeStep) != -1)
	{
		...
		if (((val_sensor_distance_front <= 650) && (val_sensor_distance_back <= 650)))
		{

...
int main(int argc, char **argv) {
  ...
  // Define os motores
  Motor *left_motor_front = robot->getMotor("front left wheel");
  Motor *left_motor_back = robot->getMotor("back left wheel");
  Motor *right_motor_front = robot->getMotor("front right wheel");
  Motor *right_motor_back = robot->getMotor("back right wheel");
  left_motor_front->setPosition(INFINITY);
  left_motor_back->setPosition(INFINITY);
  right_motor_front->setPosition(INFINITY);
  right_motor_back->setPosition(INFINITY);

...
primo(X,Y) :- progenitor(A,Y), irmao(A,B), progenitor(Y,B), X\==Y, sexo(X,masculino).
primo(X,Y) :- progenitor(A,Y), irma(A,B), progenitor(Y,B), X\==Y, sexo(X,masculino).
prima(X,Y) :- progenitor(A,Y), irmao(A,X), progenitor(Y,B), X\==Y, sexo(X,feminino).
prima(X,Y) :- progenitor(A,Y), irma(A,X), progenitor(Y,B), X\==Y, sexo(X,feminino).